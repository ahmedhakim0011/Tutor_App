...
class SignInAsTeacher extends StatefulWidget {
  @override
  State<SignInAsTeacher> createState() => _LoginPageState();
}

class _LoginPageState extends State<SignInAsTeacher> {
  ...
  moveToHome(BuildContext context) async {
    if (_formKey.currentState!.validate()) {
      ...
      await Navigator.pushNamed(context, MyRoutes.postAsTeacher);
      setState(() {
        changeButton = false;
      });
    }
            ...
            builder: (ctx) {
              return AlertDialog(
                shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(12)),
                title: Text('Error'),
                content: Text("signing unsuccessful.."),
                actions: [
                  FlatButton(
                      onPressed: () {
