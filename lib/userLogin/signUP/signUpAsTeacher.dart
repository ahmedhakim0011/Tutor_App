...
class SignUpAsTeacher extends StatefulWidget {
  @override
  State<SignUpAsTeacher> createState() => _SignUpState();
}

class _SignUpState extends State<SignUpAsTeacher> {
    ...
    if (emailTXT.isNotEmpty && passwordTXT.isNotEmpty) {
      _auth
        ...
        password: passwordTXT,
          ...
          .then((user) {
        _db.collection('teacherSignUpUsers').doc(user.user!.uid).set({
          'email': emailTXT,
        ...
        showDialog(
            ...
            builder: (ctx) {
              return AlertDialog(
                ...
                content: const Text("Sign Up Unsuccessful"),
                actions: [
                  FlatButton(
                      onPressed: () {
